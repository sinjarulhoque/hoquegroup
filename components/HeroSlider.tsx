        ...
        <div className="max-w-2xl space-y-6">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="text-on-primary-container text-xl leading-relaxed font-light mt-6">
        ...
        {slides.map((_, idx) => (
          <button
            ...
            className={`w-2 h-2 rounded-full transition-all duration-300 ${
              idx === currentSlide ? "w-8 bg-secondary-container" : "bg-white/50 hover:bg-white/80"
            }`}
          />
        ))}
      </div>
