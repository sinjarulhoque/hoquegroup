...
const companies = [
  {
    ...
    desc: "Multi-commodity agricultural export and international trade — with in-house Rice Mill at Murshidabad.",
    featured: false,
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-[#4B5563] text-[15px] max-w-[560px] mx-auto">
            A group of companies built on trust, quality, and global ambition.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {companies.map((company, idx) => (
            <motion.div
              ...
              className={`bg-white rounded-[12px] p-[36px] shadow-lg hover:shadow-2xl transition-all duration-350 hover:-translate-y-[8px] flex flex-col border-t-[6px] ${
